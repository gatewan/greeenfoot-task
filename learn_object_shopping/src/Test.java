...
public class Test {
    public static void main(String[] args) {
        ...
        Barang b1 = new Barang(123, "Flashdisk", 135000);
        Barang b2 = new Barang(124, "Mouse", 100000);
        Barang b3 = new Barang(125, "Hard Disk 1T", 900000);
        ...
        // tampil data
        System.out.println("Nama Suplier  : " + pembelian.getSuplier().getNama());
        System.out.println("Alamat Suplier: " + pembelian.getSuplier().getAlamat());
        System.out.println("Detail Barang yg dibeli:");
